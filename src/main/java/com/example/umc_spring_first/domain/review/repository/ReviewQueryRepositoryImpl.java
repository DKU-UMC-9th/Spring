...
public class ReviewQueryRepositoryImpl implements ReviewQueryRepository {
    ...
    // 특정 가게(storeId)의 전체 리뷰 조회
    @Override
    public Page<MyReviewRowDto> findStoreReviews(Long storeId, Integer starBand, Pageable pageable) {
        QReview r = QReview.review;
        QStore s = QStore.store;

        BooleanBuilder where = new BooleanBuilder();
        where.and(s.id.eq(storeId));
    ...
    //별점별 리뷰 조회
    @Override
    public Page<MyReviewRowDto> findReviewsByStar(Integer starBand, Pageable pageable) {
        QReview r = QReview.review;
        QStore s = QStore.store;
