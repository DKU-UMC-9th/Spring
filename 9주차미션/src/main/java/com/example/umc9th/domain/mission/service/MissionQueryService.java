...
public class MissionQueryService {
    ...
    public MissionResDTO.MissionPreviewListDTO getMissionsByUser(Long userId, Integer page) {
        PageRequest pageable = PageRequest.of(page - 1, 10); // 프론트엔드 1-based
        Page<Mission> missionPage = userMissionRepository.findByUserIdAndStatus(userId, "IN_PROGRESS", pageable);
